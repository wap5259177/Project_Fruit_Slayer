...
@Entity
@Table(name = "t_pcii")
public class ProvinceCapitalInvestmentInformationEntity extends CapitalInvestmentInformationEntity{

	/**
	 * 
	 */
	private static final long serialVersionUID = -3806025354444021746L;
