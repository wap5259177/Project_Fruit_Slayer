...
@MappedSuperclass
public abstract class AbstractSurveySummaryEntity extends AbstractPersistable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -7691340461120520937L;
	...
	public void clear(){
		this.agriculturalHousehold = 0;
		this.agriculturalPopulation = 0;
		this.villageCommittee = 0;
		this.naturalVillage = 0;
		this.villagePlanning = 0;

		this.unifiedStyle = 0;
		this.hardBottom = 0;
		this.tapWater = 0;
		this.spcvgb = 0;
		this.villageRenovation = 0;
		
		this.cleaningTeam = 0;
		this.rainSewageDiversion = 0;
		this.sewageTreatment = 0;
		this.livestockConcentratedCaptive = 0;
		this.villagerCouncil = 0;
	}
	
	public void sum(AbstractSurveySummaryEntity o){
		this.agriculturalHousehold += o.agriculturalHousehold;
		this.agriculturalPopulation += o.agriculturalPopulation;
		this.villageCommittee += o.villageCommittee;
		this.naturalVillage += o.naturalVillage;
		this.villagePlanning += o.villagePlanning;

		this.unifiedStyle += o.unifiedStyle;
		this.hardBottom += o.hardBottom;
		this.tapWater += o.tapWater;
		this.spcvgb += o.spcvgb;
		this.villageRenovation += o.villageRenovation;
		
		this.cleaningTeam += o.cleaningTeam;
		this.rainSewageDiversion += o.rainSewageDiversion;
		this.sewageTreatment += o.sewageTreatment;
		this.livestockConcentratedCaptive += o.livestockConcentratedCaptive;
		this.villagerCouncil += o.villagerCouncil;
	}
