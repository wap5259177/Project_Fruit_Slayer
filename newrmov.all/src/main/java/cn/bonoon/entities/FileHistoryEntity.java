 ...
 */
@Entity
@Table(name = "t_filehistory")
public class FileHistoryEntity extends AbstractPersistable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5640547728682525828L;
	...
	public String getDate(){
		return StringHelper.datetime2String(createAt);
	}
