...
public class TotalInvestmentProjectExcel extends AbstractExcelUtil {

	private Collection<Object[]> items;
	private String batch;

	public TotalInvestmentProjectExcel() {
	}

	public TotalInvestmentProjectExcel(Collection<Object[]> items, String batch) {
		this.items = items;
		this.batch = batch;
	}
	...
	protected void buildExcelDocument(Map<String, Object> model,
		...
		String sheetName = "工程项目计划总投入资金统计" + "(批次" + batch + ")";
		...
		this.setCellValueAndCellStyle(1, 2, "计划总投入资金", style);
		...
		String[] tableColumnName2 = new String[] { "E9[万元]", "E10[万元]",
				"E11[万元]", "E12[万元]", "E131[万元]", "E132[万元]", "E14[万元]",
				"E141[万元]", "E15[万元]" };
