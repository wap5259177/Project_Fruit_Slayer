...
@Controller
@RequestMapping("s/cl/town/closed")
public class ReportingClosedTownApplicantController extends AbstractTownApplicantController{

	@Autowired
	public ReportingClosedTownApplicantController(TownApplicantService service) {
		super(service);
	}
