...
@Controller
@RequestMapping("s/cl/town/back")
public class ReportingBackTownApplicantController extends AbstractTownApplicantController{

	@Autowired
	public ReportingBackTownApplicantController(TownApplicantService service) {
		super(service);
	}

	@GridStandardDefinition(
			detailClass = TownApplicantDetail.class, 
			updateClass = BackTownApplicantEditor.class,
