...
@Controller
@RequestMapping("s/ml/town/back")
public class ManagerBackTownApplicantController extends AbstractTownApplicantController{

	@Autowired
	public ManagerBackTownApplicantController(TownApplicantService service) {
		super(service);
	}
