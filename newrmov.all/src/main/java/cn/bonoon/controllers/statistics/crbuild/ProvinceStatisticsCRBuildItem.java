...
@AsDataGrid(condition = PageCondition.class, value= @GridOptions(operationWith = 240))
public class ProvinceStatisticsCRBuildItem extends AbstractItem implements ProvinceStatisticsCRBuildDefine {
