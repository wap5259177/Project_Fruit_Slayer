...
@InsertCell(value = "information/pv-village-view.vm", type = EmbedType.PARSE)
@WithDialog(initializer = PCVillageDetailInitializer.class, closeButton = false, title = "广东省自然村户数情况表")
public class PCVillageDetail extends ObjectEditor{
