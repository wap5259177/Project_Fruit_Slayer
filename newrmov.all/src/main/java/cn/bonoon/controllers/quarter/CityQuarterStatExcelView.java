...
public class CityQuarterStatExcelView extends AbstractExcelView{
    private final ModelAreaQuarterItem item;
    
   	@Autowired
   	CityQuarterStatExcelView(ModelAreaQuarterItem item){
   		this.item=item;
   	}
   	@Override
   	protected void buildExcelDocument(Map<String, Object> model,
   		...
   		String shellName;
   	    shellName = "广东省"+item.getCityName()+item.getModelArea().getName()+"规划进展汇总统计";
