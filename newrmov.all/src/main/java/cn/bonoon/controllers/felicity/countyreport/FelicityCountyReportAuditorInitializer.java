...
public class FelicityCountyReportAuditorInitializer implements DialogFormInitializer<FelicityCountyReportEntity>{

	@Override
	public Object init(IService<FelicityCountyReportEntity> service,
