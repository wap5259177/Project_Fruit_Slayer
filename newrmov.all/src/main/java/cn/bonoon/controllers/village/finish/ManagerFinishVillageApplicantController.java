...
@Controller
@RequestMapping("s/ml/village/finish")
public class ManagerFinishVillageApplicantController extends AbstractVillageApplicantController{

	@Autowired
	public ManagerFinishVillageApplicantController(VillageApplicantService service) {
		super(service);
	}
