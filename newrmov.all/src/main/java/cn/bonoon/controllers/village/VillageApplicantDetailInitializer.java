...
public class VillageApplicantDetailInitializer implements DialogFormInitializer<VillageApplicantEntity>{
	...
	public Object init(IService<VillageApplicantEntity> service, DialogModel model, DialogEvent event, Long id, Object form) {
		...
		VillageApplicantHelper.view(vaService, model, event, form, false);
