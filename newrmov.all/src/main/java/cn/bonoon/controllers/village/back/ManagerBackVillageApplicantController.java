...
@Controller
@RequestMapping("s/ml/village/back")
public class ManagerBackVillageApplicantController extends AbstractVillageApplicantController{

	@Autowired
	public ManagerBackVillageApplicantController(VillageApplicantService service) {
		super(service);
	}
