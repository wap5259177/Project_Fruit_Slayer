...
@Controller
@RequestMapping("s/cl/village/pendingaudit")
public class ReportingPendingauditVillageApplicantController extends AbstractVillageApplicantController{

	@Autowired
	public ReportingPendingauditVillageApplicantController(VillageApplicantService service) {
		super(service);
	}
