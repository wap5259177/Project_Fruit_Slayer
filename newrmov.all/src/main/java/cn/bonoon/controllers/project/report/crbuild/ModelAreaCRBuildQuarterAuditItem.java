...
@AsDataGrid
public class ModelAreaCRBuildQuarterAuditItem extends AbstractItem implements ModelAreaCRBuildQuarterAuditDefine{
	...
	@AsColumn(width = 50, ordinal = 10,sortable=false)
	private String batchName;
	
	@TransformField("batch.quarter.")
	@AsColumn(width = 280, ordinal = 14,sortable=false)
