...
public class ProjectUpdateBaseInfoEditorInitializer implements DialogFormInitializer<ProjectEntity>{
...
//					.append('[').append(it[2]).append("]</option>");
		...
		ProjectUpdateBaseInfoEditor _form = (ProjectUpdateBaseInfoEditor)form;
		if(_form!=null){
			if(_form.getIsUpdate()==true){
