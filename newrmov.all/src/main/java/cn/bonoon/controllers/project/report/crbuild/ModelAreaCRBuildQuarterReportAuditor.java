...
@Transform
@FormUpdate(3)
@InsertCell(value = "report/crbuild/crbuild-quarter-audit.vm", type = EmbedType.PARSE)
@WithDialog(initializer = ModelAreaCRBuildQuarterReportAuditorInitializer.class, height = 550)
@DialogDefaultButton(
		buttonName = "通过审核",
...
@TabHome(name = "示范片区报表")
public class ModelAreaCRBuildQuarterReportAuditor extends FelicityCountyReportInfo{
